      ...
      <main>
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <button className="px-10 py-4 rounded-full bg-white text-neutral-950 font-bold text-lg hover:bg-emerald-50 transition-all hover:scale-105 shadow-[0_0_50px_-10px_rgba(255,255,255,0.2)]">
