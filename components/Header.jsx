        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a 
              href="#pricing"
              className={`
                px-5 py-2 rounded-full font-semibold text-sm transition-all hover:scale-105 active:scale-95 flex items-center
                ${scrolled 
          ...
          <div className={`
            absolute top-full left-0 right-0 mt-2 p-2 rounded-2xl bg-neutral-900/95 backdrop-blur-xl border border-white/10 overflow-hidden transition-all duration-300 origin-top
